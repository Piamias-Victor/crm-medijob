...
1. **Explique en français simple** : sur une **Mission**, on crée un **Devis** brouillon pour la **Pharmacy**. Prix **libre** : heures + taux puis Calculer (moteur WeTransfer), **ou** HT tapé. Les heures restent modifiables ; un HT tapé ne se recale pas tout seul. CDD/CDI = forfait HT. Pas d’envoi, pas de packs tarifs Medijob. Recruteur voit HT/TTC **et** peut saisir la **Marge**. Pas de **CA**. La page Facturation globale (stats) n’est pas dans cette slice.
...
- [ ] CDD/CDI forfait HT
- [ ] Recruteur : HT/TTC + Marge éditables, pas CA
...
- [ ] Compte Recruteur : Marge éditable ; pas de CA
