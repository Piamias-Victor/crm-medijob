...
export const DEVIS_ACCEPTED_LOG = 'Devis accepté'
...
export const DEVIS_ACCEPT_LABEL = 'Accepter'
export const DEVIS_ACCEPTING_LABEL = 'Acceptation…'
export const DEVIS_ACCEPT_SUCCESS = 'Devis accepté'
export const DEVIS_INVOICE_LABEL = 'Facturé le'
export const DEVIS_INVOICE_SAVE_LABEL = 'Marquer facturé'
export const DEVIS_INVOICE_SAVING_LABEL = 'Enregistrement…'
export const DEVIS_INVOICE_SUCCESS = 'Devis marqué facturé'
