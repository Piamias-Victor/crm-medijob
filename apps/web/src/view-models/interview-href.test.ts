...
import { interviewCandidateFichePath, interviewClosePath, interviewDraftPath, interviewStartPath } from '@/view-models/interview-href'
...
describe('interview hrefs', () => {
  it('builds start, draft and fiche paths', () => {
    ...
    expect(interviewClosePath('c1', 'i1')).toBe('/candidats/c1/entretiens/i1/cloture')
