...
export function projectNoGo(items: PilotageContribution[]) {
  ...
  return {
    billedCa,
    nogoCount,
    lostCa: avg(byType.CDD) * byType.CDD.nogoCount + avg(byType.CDI) * byType.CDI.nogoCount,
  }
}
