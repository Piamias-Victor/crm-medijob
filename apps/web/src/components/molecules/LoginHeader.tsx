...
export function LoginHeader() {
  return (
    <motion.header {...LOGIN_HEADER_MOTION} className="mb-7 text-center">
      <div className="relative mx-auto mb-5 flex h-14 items-center justify-center">
        <span
          aria-hidden
          className="absolute inset-x-6 -inset-y-1 rounded-2xl bg-accent/25 blur-xl motion-safe:animate-pulse"
        />
        <MedijobLogo className="relative h-12 w-auto max-w-[14rem] drop-shadow-sm" />
      </div>
